 ...
 * button → the real handleAddDocument → real resolvePickedFileUri → the Shared RAG application → real
 * document extraction, which stats the file (memfs) and enforces MAX_FILE_SIZE. The only fakes are device
 * leaves: the document picker, the filesystem, and the SQLite driver.
 *
