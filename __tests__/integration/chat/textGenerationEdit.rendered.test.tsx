...
describe('Mobile text generation edit journey', () => {
  it('keeps a start-of-message edit through the iOS keyboard render and resends it', async () => {
    ...
    await h.rtl.waitFor(() => {
      expect(
        view.getByText('Please give me a short greeting.'),
      ).toBeVisible();
      expect(view.getByText('Hello from the edited reply.')).toBeVisible();
      expect(view.queryByText('Give me a short greeting.')).toBeNull();
