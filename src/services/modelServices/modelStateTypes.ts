...
export type MemoryCheckSeverity = MemoryAdvisorySeverity;
...
export const IMAGE_MODEL_OVERHEAD_MULTIPLIER =
  imageRuntimeMemoryMultiplier(Platform.OS);
