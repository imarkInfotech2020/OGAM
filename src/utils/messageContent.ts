...
export const XML_TOOL_CALL_PARAMETER_MARKER =
  SHARED_XML_TOOL_CALL_PARAMETER_MARKER;
...
import {
  ...
  XML_TOOL_CALL_PARAMETER_MARKER as SHARED_XML_TOOL_CALL_PARAMETER_MARKER,
