...
const createHeaderStyles = (colors: ThemeColors) => ({
  ...
  headerTitleRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6, marginBottom: 2 },
  headerTitle: { ...TYPOGRAPHY.h2, color: colors.text, flexShrink: 1 },
  headerProjectBadge: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
  ...
  headerProjectBadgeText: { ...TYPOGRAPHY.meta, color: colors.primary, fontSize: 11 },
