...
const createHeaderStyles = (colors: ThemeColors) => ({
  ...
  headerSubtitleRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 6 },
  headerSubtitleDivider: { ...TYPOGRAPHY.meta, color: colors.textMuted },
  headerProjectRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 3 },
