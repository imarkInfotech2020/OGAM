...
const createTextModelsStyles = (colors: ThemeColors, _shadows: ThemeShadows) => ({
  ...
  featuredCardNameGroup: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    flex: 1,
    gap: 6,
  },
  featuredCardName: { ...TYPOGRAPHY.h3, color: colors.text },
  featuredAuthorTag: {
  ...
  featuredAuthorTagText: { ...TYPOGRAPHY.metaSmall, color: colors.textSecondary },
  featuredBadge: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    gap: 3,
  ...
  featuredBadgeText: { ...TYPOGRAPHY.labelSmall, color: colors.primary },
  featuredDescription: {
  ...
  featuredChipText: { ...TYPOGRAPHY.labelSmall, color: colors.primary },
  featuredFooter: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    justifyContent: 'space-between' as const,
  ...
  featuredHighlight: { ...TYPOGRAPHY.meta, color: colors.textMuted, flex: 1 },
  featuredGetButton: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    gap: 4,
  ...
  featuredGetText: { ...TYPOGRAPHY.bodySmall, color: colors.primary },
});
